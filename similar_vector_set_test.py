...
"""
detect whether a set of vectors all are almost the same using a cosine measure. 
This is used to speed up k-means by avoiding it when all the vectors are too similar to be clustered. 
"""
